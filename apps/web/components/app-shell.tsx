...
const navItems: Array<{ href: Route; label: string }> = [
  ...
  { href: "/search" as Route, label: "🔍 Global Search" },
  { href: "/vendors" as Route, label: "🤝 Vendor Ecosystem" },
  { href: "/vendors/contracts" as Route, label: "📜 Vendor Contracts" },
  { href: "/vendors/compliance" as Route, label: "🛡️ Vendor Compliance" },
  { href: "/vendors/analytics" as Route, label: "📊 Vendor Analytics" },
  { href: "/contractors" as Route, label: "👷 Contractor Master" },
  { href: "/contractors/muster" as Route, label: "📋 Muster Roll" },
  { href: "/contractors/attendance" as Route, label: "⏱️ Contractor Attendance" },
  { href: "/contractors/billing" as Route, label: "💳 Contractor Billing" },
  { href: "/assets" as Route, label: "💻 Asset Lifecycle" },
  { href: "/assets/inventory" as Route, label: "📦 Asset Inventory" },
  { href: "/assets/assignments" as Route, label: "👤 Asset Allocations" },
  { href: "/assets/maintenance" as Route, label: "🛠️ Asset Maintenance" },
  { href: "/assets/audit" as Route, label: "📷 Asset QR Audit" },
  { href: "/visitors" as Route, label: "🎫 Visitor Management" },
  { href: "/facilities" as Route, label: "🏢 Facility Cockpit" },
  { href: "/meeting-rooms" as Route, label: "📅 Meeting Rooms" },
  { href: "/parking" as Route, label: "🚗 Parking Bays" },
  { href: "/admin/executive-intelligence" as Route, label: "👑 CEO Executive Intelligence" },
  { href: "/admin/chro-intelligence" as Route, label: "👥 CHRO Talent Intelligence" },
  { href: "/admin/cfo-intelligence" as Route, label: "💰 CFO Budget Intelligence" },
  { href: "/admin/audit-center" as Route, label: "🔒 Immutable Audit Center" },
...
const mobileNavItems: Array<{ href: Route; label: string }> = [
  ...
  { href: "/vendors" as Route, label: "🤝 Vendors" },
  { href: "/contractors" as Route, label: "👷 Contractors" },
  { href: "/assets" as Route, label: "💻 Assets" },
  { href: "/visitors" as Route, label: "🎫 Visitors" },
  { href: "/meeting-rooms" as Route, label: "📅 Meeting Rooms" },
  { href: "/admin/executive-intelligence" as Route, label: "👑 Executive AI" },
