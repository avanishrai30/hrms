...
const navItems: Array<{ href: Route; label: string }> = [
  ...
  { href: "/payroll/payslips" as Route, label: "📄 My Payslips" },
  { href: "/payroll/tax-declaration" as Route, label: "⚖️ IT Declaration" },
  { href: "/payroll/tax-proofs" as Route, label: "📎 Tax Proofs" },
  { href: "/payroll/form16" as Route, label: "📑 Form 16 TDS" },
  { href: "/payroll/compensation" as Route, label: "💼 CTC Structure" },
  { href: "/payroll/loans" as Route, label: "💳 Loans & Advances" },
  { href: "/payroll/reimbursements" as Route, label: "🧾 Reimbursements" },
  { href: "/finance/payroll" as Route, label: "💰 Enterprise Payroll Hub" },
  { href: "/finance/payroll-runs" as Route, label: "⚙️ Payroll Runs" },
  { href: "/finance/salary-structures" as Route, label: "📊 Salary Bands" },
  { href: "/finance/payroll-approvals" as Route, label: "✅ Payroll Approvals" },
  { href: "/finance/tax-center" as Route, label: "⚖️ Corporate Tax Center" },
  { href: "/finance/statutory" as Route, label: "🏛️ Statutory PF/ESIC" },
  { href: "/finance/bonus-management" as Route, label: "🎁 Bonus Administration" },
  { href: "/finance/incentives" as Route, label: "🎯 Sales Incentives" },
  { href: "/finance/revisions" as Route, label: "📈 Salary Revisions" },
  { href: "/finance/fnf" as Route, label: "🚪 Full & Final (FnF)" },
  { href: "/finance/gratuity" as Route, label: "📜 Gratuity Engine" },
  { href: "/finance/payroll-analytics" as Route, label: "📈 Payroll Analytics" },
  { href: "/admin/payroll-intelligence" as Route, label: "👔 Executive Payroll Cockpit" },
  { href: "/engagement" as Route, label: "🌟 Culture & Engagement Hub" },
  { href: "/engagement/surveys" as Route, label: "📝 Engagement Surveys" },
  { href: "/engagement/pulse" as Route, label: "⚡ Pulse Check" },
  { href: "/engagement/enps" as Route, label: "📊 eNPS Feedback" },
  { href: "/engagement/recognition" as Route, label: "🏆 Kudos & Awards" },
  { href: "/engagement/rewards" as Route, label: "🎁 Rewards Wallet" },
  { href: "/engagement/catalog" as Route, label: "🛍️ Reward Catalog" },
  { href: "/engagement/communities" as Route, label: "👥 Communities & Clubs" },
  { href: "/engagement/social-wall" as Route, label: "📱 Social Feed" },
  { href: "/engagement/suggestions" as Route, label: "💡 Suggestion Box" },
  { href: "/engagement/challenges" as Route, label: "🚀 Hackathons & Challenges" },
  { href: "/engagement/my-badges" as Route, label: "🏅 My Badges" },
  { href: "/admin/engagement" as Route, label: "🏢 Engagement Admin" },
  { href: "/admin/surveys" as Route, label: "📝 Survey Designer" },
  { href: "/admin/enps" as Route, label: "📊 eNPS Engine" },
  { href: "/admin/recognition" as Route, label: "🏆 Badge Admin" },
  { href: "/admin/rewards" as Route, label: "🎁 Catalog Admin" },
  { href: "/admin/culture" as Route, label: "🌱 Culture & Values" },
  { href: "/admin/community-management" as Route, label: "👥 Community Governance" },
  { href: "/admin/engagement-analytics" as Route, label: "📈 Morale Analytics" },
  { href: "/admin/culture-intelligence" as Route, label: "🧠 Culture Intelligence Cockpit" },
...
const mobileNavItems: Array<{ href: Route; label: string }> = [
  ...
  { href: "/ess" as Route, label: "🏠 ESS Hub" },
  { href: "/ess/profile" as Route, label: "👤 ESS Profile Center" },
  { href: "/ess/requests" as Route, label: "📨 ESS Requests Hub" },
  { href: "/ess/documents" as Route, label: "📁 ESS Document Vault" },
  { href: "/ess/letters" as Route, label: "📄 HR Letter Generator" },
  { href: "/ess/helpdesk" as Route, label: "🎫 ESS Helpdesk" },
  { href: "/ess/wallet" as Route, label: "💳 Digital Wallet" },
  { href: "/ess/timeline" as Route, label: "⏳ Journey Timeline" },
  { href: "/mss" as Route, label: "👔 MSS Hub" },
  { href: "/mss/team" as Route, label: "👥 MSS Team Roster" },
  { href: "/mss/approvals" as Route, label: "✅ MSS Approvals" },
  { href: "/org-chart" as Route, label: "🌲 Interactive Org Chart" },
  { href: "/communications" as Route, label: "📢 Broadcasts Hub" },
  { href: "/communications/news" as Route, label: "📰 Company News" },
  { href: "/communications/policies" as Route, label: "📜 Policies & SOPs" },
  { href: "/admin/helpdesk" as Route, label: "🛠️ Helpdesk Operations" },
  { href: "/admin/service-delivery" as Route, label: "📈 Service Delivery Analytics" },
  { href: "/admin/communications" as Route, label: "📣 Broadcast Publisher" },
  { href: "/admin/employee-experience" as Route, label: "🌟 Employee Experience Cockpit" },
